 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Hutchinson Pryor");
		  toPrint += p1.toString("hpryor3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Olivia LaHay");
		  toPrint += p2.toString("olahay3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Afiq Azaibi");
		  toPrint += p3.toString("aazaibi6");
                    //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Sarah Alsmiller");
                  toPrint += p4.toString("salsmiller3");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Lawrence-Moore");
                  toPrint += p5.toString("lmoore44");
